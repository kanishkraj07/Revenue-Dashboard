export function PayoutHeader() {
    return <div className="inline-flex justify-between bg-white p-5 md:flex border-b border-b-solid border-b-[rgba(0,0,0,0.2)]">
        <div className="flex justify-center items-center gap-3 ">
            <div className="text-black text-lg sm:text-2xl">InstantPay</div>
        ...
        <div className="w-15 mx-5 sm:w-30 md:w-50 lg:w-1/3 flex justify-center items-center gap-4 px-3 py-2 bg-[#f2f2f2] rounded-lg">
        ...
        <div className="flex justify-center align-center gap-3">
            <div className="w-10 h-10 rounded-full bg-[#f2f2f2] flex justify-center items-center">
