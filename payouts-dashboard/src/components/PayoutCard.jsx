export function PayoutCard({ varient, title, amount, ordersCount, footerTitle, footerVal }) {
    ...
    <div className= {(varient === "primary" ? "rounded-b-none" : "") + " bg-white rounded shadow flex flex-col gap-2 justify-center p-5"}>
            ...
            <div className="flex justify-between items-center">
                ...
                {ordersCount ? <div className="text-base underline flex font-medium cursor-pointer text-sky-700">{ordersCount} Orders 
    ...
    {varient === "primary" ? <div className="bg-[#64748b] flex justify-between text-cream-300 text-base font-normal rounded shadow px-5 py-2 rounded-t-none">
                <div>{footerTitle}:</div>
                <div>{footerVal}</div>
            </div> : null }
    </div>
